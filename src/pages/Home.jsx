...
const Home = () => (
  <section id="home" className="h-[90x flex flex-col justify-start items-center pt-12 pb-0">
    ...
    <h1 className="text-4xl md:text-5 font-extrabold mb-4 text-center leading-tight">Hi, I'm Bhabesh Behera.<br /><span className="text-black dark:text-white">Software Engineer</span></h1>
