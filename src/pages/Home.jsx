...
const Home = () => (
  <BackgroundLines className="h-[90vh] flex flex-col justify-start items-center pt-12 pb-0">
    <div className="relative z-20 flex flex-col items-center">
      ...
      <a 
        href="#contact" 
        className="inline-block px-8 py-3 bg-black dark:bg-white text-white dark:text-black rounded-xl font-bold shadow-lg hover:bg-gray-900 dark:hover:bg-gray-200 transition mb-4 text-lg border border-gray-300 dark:border-gray-700 relative z-20"
        onClick={(e) => {
          e.preventDefault();
